...
},{"bootstrap":"node_modules/bootstrap/dist/js/bootstrap.esm.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var API_KEY = "live_4ngGyd0byb0H7cwexIBko0YgCSRSMZOp6oTQFUtKbKrxHDFiIbtgYSYNO5KW2BXW";
...
breedSelect.addEventListener('change', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var selectedBreedId, response, breedInfo;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        selectedBreedId = breedSelect.value; // Clear the carousel
        Carousel.clear();
        // Retrieve information on the selected breed from the cat API
        _context.prev = 2;
        _context.next = 5;
        return fetch("https://api.thecatapi.com/v1/images/search?limit=5&breed_ids=".concat(selectedBreedId), {
          headers: {
            "x-api-key": API_KEY
          }
        });
      ...
      case 8:
        ...
        breedInfo.forEach(function (info) {
          var imgSrc = info.url;
          var imgAlt = info.breeds[0].name;
          var imgId = info.id;
          var carouselItem = Carousel.createCarouselItem(imgSrc, imgAlt, imgId);
          Carousel.appendCarousel(carouselItem);
        });
        // Populate the informational section within the infoDump element
        infoDump.innerHTML = "\n          <h2>".concat(breedInfo[0].breeds[0].name, "</h2>\n          <p>").concat(breedInfo[0].breeds[0].description, "</p>\n          <p>Origin: ").concat(breedInfo[0].breeds[0].origin, "</p>\n          <p>Life Span: ").concat(breedInfo[0].breeds[0].life_span, "</p>\n      ");
        _context.next = 16;
        break;
      case 13:
        _context.prev = 13;
        _context.t0 = _context["catch"](2);
        console.error("Error fetching breed information:", _context.t0);
      case 16:
...
//# sourceMappingURL=/ajax-fetch-and-axios-lab-template-forked.e31bb0bc.js.map